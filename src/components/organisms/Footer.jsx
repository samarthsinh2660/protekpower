                ...
                <div className="footer-main-section">
                    <div className="footer-logo-section">
                        ...
                        <div className="footer-social-icons">
                            ...
                            <a href="https://instagram.com/protekpower" target="_blank" rel="noopener noreferrer" className="footer-social-link">
                ...
                <div className="footer-links-row">
                    {allLinks.map((link, index) => (
                        <React.Fragment key={index}>
                            ...
                            {index < allLinks.length - 1 && <span className="footer-divider">|</span>}
                        </React.Fragment>
                    ))}
                </div>
